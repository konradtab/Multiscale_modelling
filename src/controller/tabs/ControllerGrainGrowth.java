...
import static model.ModelGrainGrowth.EdgeType.Periodic;
...
public class ControllerGrainGrowth implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        String[] neighboursOptions = new String[]{"von Neuman",
                //"Moore", "Pentagonal left", "Pentagonal right", "Pentagonal up", "Pentagonal down", "Pentagonal random", "Hexagonal left", "Hexagonal right", "Hexagonal random"
        };
        ...
        String[] edgeOptions = new String[]{"Closed",
                //"Periodic"
                };
        ...
        String[] placementOptions = new String[]{"Random",
                //"Evenly placement", "Placement with radius", "Monte Carlo"
                };
